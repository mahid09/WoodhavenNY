...
public class RealApr extends NavigationBar {
    ...
    private final By InterestInputField = By.name("Interest");
    ...
    public RealApr waitForPageToLoad(){
        LOGGER.debug("Waiting for to page load");
    ...
    public RealApr typeInterestRate(String value){
        ...
        ActOn.element(driver, InterestInputField).setValue(value);
        return this;
    }
    ...
    public RealApr validateRealAprRate(String expectedValue){
        LOGGER.debug("Validating the Real Apr rate: " + expectedValue);
